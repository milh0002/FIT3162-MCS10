...
def strip_optimizer(device='cpu',f='D:\Monash\Year3sem2\FIT3162\GitHub\yolov7_pose_estimation\yolov7-w6-pose.pt', s=''):  # from utils.general import *; strip_optimizer()
